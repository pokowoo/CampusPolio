...
class UserControllerTest {
    ...
    @Test
    @DisplayName("세션이 없으면 회원 탈퇴 시 401을 반환한다")
    void withdraw_withoutSession_returnsUnauthorized() throws Exception {
    ...
    @Test
    @DisplayName("세션이 있으면 회원 탈퇴에 성공하고 세션을 무효화한다")
    void withdraw_withSession_successAndInvalidatesSession() throws Exception {
        MockHttpSession session = new MockHttpSession();
        session.setAttribute(SessionConst.LOGIN_USER_ID, 1L);
